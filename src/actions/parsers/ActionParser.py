...
from src.actions.parsers.transfer.TransferActionParser import TransferActionParser
...
from src.actions.parsers.talk.TalkActionParser import TalkActionParser
...
class ActionParser:
    PARSERS = {
        ...
        ActionType.TRANSFER: TransferActionParser(),
        ActionType.TALK: TalkActionParser(),
