...
import os
import typing
from src.interactables.base.builders.CSVInteractableBuilder import CSVInteractableBuilder, Interactable
...
class CSVInteractableBuilderTests(unittest.TestCase):
    ...
    def test_build_interactable_has_correct_name(self):
        ...
        interactable = builder.BuildInteractable(Interactable(self.DEFAULT_NAME))
